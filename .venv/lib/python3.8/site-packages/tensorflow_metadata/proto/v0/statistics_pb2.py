...
_FEATURENAMESTATISTICS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='validation_derived_source', full_name='tensorflow.metadata.v0.FeatureNameStatistics.validation_derived_source', index=8,
...
_FEATURENAMESTATISTICS.fields_by_name['validation_derived_source'].message_type = tensorflow__metadata_dot_proto_dot_v0_dot_derived__feature__pb2._DERIVEDFEATURESOURCE
